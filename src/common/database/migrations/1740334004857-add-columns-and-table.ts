...
export class AddColumnsAndTable1740334004857 implements MigrationInterface {
    name = 'AddColumnsAndTable1740334004857'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "playlists" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "userId" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_a4597f4189a75d20507f3f7ef0d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "songs" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "releaseDate" date NOT NULL, "duration" TIME NOT NULL, "lyrics" text NOT NULL, "coverImage" character varying NOT NULL, "popularity" integer NOT NULL, "genre" character varying(100) NOT NULL DEFAULT 'Other', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "albumId" integer, CONSTRAINT "PK_e504ce8ad2e291d3a1d8f1ea2f4" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."subscription_plan_enum" AS ENUM('monthly', 'annual')`);
        await queryRunner.query(`CREATE TABLE "subscription" ("subscriptionId" SERIAL NOT NULL, "plan" "public"."subscription_plan_enum" NOT NULL, "subscribedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "expiresAt" TIMESTAMP WITH TIME ZONE, "active" boolean NOT NULL DEFAULT false, "discount" character varying, "userId" integer, CONSTRAINT "PK_13cecd7da6abc7ae934d8560bef" PRIMARY KEY ("subscriptionId"))`);
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "phone" character varying NOT NULL, "email" character varying NOT NULL, "subscription" character varying NOT NULL DEFAULT 'free', "terms_of_service" character varying NOT NULL DEFAULT 'false', "password" character varying NOT NULL, "apiKey" character varying NOT NULL, "refresh_token" character varying NOT NULL, "verified_email" boolean NOT NULL, "verified_phone" boolean NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
