...
export const emailVerificationTemplate = (
  ...
  return {
    ...
    text: `Hello ${username}! Welcome to the TuneStream family. We are so thrilled to have you onboard! Please use the code, ${code}, to verify your email.`,
                  ...
                  <div class="container">
                    <main>
                      ...
                      <div class="body">
                        ...
                        <p>
                          Welcome to the TumeStream family! We are so thrilled to have you
                          onboard. <br />
                        ...
                        <h3>${code}</h3>
                        <p>Note: This code will expires within 5 mins !</p>
                      </div>

                      <div class="footer">
                        <small
                          >This message was intended for ${username}. If you did not sign up
                          on TumeStream&trade;, <br />please ignore this email.</small
                        >
                      </div>
                    </main>
                  </div>
...
export const resetPasswordTemplate = (
  ...
  return {
    ...
    text: `Dear ${username}, you requested to reset your password on TumeStream. Use the 4-digit token below to initiate a password reset.`,
                  ...
                  <main>
                    ...
                    <div class="ps">
                      <small>This message was intended for ${username}. If you did not request a
                        password reset from TumeStream&trade;, please ignore this email.</small>
                    </div>
                  </main>
                </div>
              </body>
                  ...
                  <main>
                    ...
                    <div class="body">
                      ...
                      <p>
                        ...
                        <strong>TumeStream&trade;.</strong>
                      </p>
                      <p class="timestamp">
                    ...
                    <div class="ps">
                      <small>This message was intended for ${username}. If you did not initiate a
                        password update on TumeStream&trade;, please ignore this email.</small>
                    </div>
                  </main>
                </div>
              </body>
