...
export class MyMigration1735219327256 implements MigrationInterface {
    name = 'MyMigration1735219327256'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "playlists" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "userId" integer, "songsId" integer, CONSTRAINT "PK_a4597f4189a75d20507f3f7ef0d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "artists" ("id" SERIAL NOT NULL, "stageName" character varying NOT NULL, "userId" integer, CONSTRAINT "REL_f7bd9114dc2849a90d39512911" UNIQUE ("userId"), CONSTRAINT "PK_09b823d4607d2675dc4ffa82261" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "playlists" ADD CONSTRAINT "FK_9403e08269d2061bf5e6036a400" FOREIGN KEY ("songsId") REFERENCES "songs"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "playlists" DROP CONSTRAINT "FK_9403e08269d2061bf5e6036a400"`);
